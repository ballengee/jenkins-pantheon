    ...
    class Rest_Authentication_Service_Cookies
    {
        ...
        public static function authenticate_request($errors)
        {
            ...
            foreach ($wp_rest_cookies_protected_endpoints as $wp_rest_cookies_protected_endpoint) {
                ...
                // 1. REQUEST TYPE
                if (empty($_SERVER['REQUEST_METHOD']) || false === stripos($wp_rest_cookies_protected_endpoint['value'], $_SERVER['REQUEST_METHOD'])) {
                ...
                // 2. PATH
                if (stripos($GLOBALS['WPO_CONFIG']['url_info']['request_uri'], $wp_rest_cookies_protected_endpoint['key']) !== false) {
